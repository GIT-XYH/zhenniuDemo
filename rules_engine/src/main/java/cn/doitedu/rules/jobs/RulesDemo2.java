...
import cn.doitedu.rules.udfs.RulesMatchFunction2;
...
public class RulesDemo2 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //对KeyBy之后的数据进行处理
        SingleOutputStreamOperator<MatchResult> res = keyedStream.process(new RulesMatchFunction2());
