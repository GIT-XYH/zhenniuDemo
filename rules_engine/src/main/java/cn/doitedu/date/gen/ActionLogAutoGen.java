 ...
 *
 * kafka中要先创建好topic
 * bin/kafka-topics.sh --create --topic zenniu-applog --partitions 2 --replication-factor 1 --zookeeper hdp01:2181,hdp02:2181,hdp03:2181
 *
 * 创建完后，检查一下是否创建成功：
 * bin/kafka-topics.sh --list --zookeeper hdp01:2181
 *
 */
